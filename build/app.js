...
/***/ function(module, exports, __webpack_require__) {
	...
	_reactDom2.default.render(_react2.default.createElement(_routes2.default, null), document.body); /**
	  ...
	  _createClass(ProfileInfo, [{
	    ...
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement('img', { src: 'assets/images/tay_ai.bmp',
	    ...
	    value: function render() {
	      return _react2.default.createElement(
	        ...
	        this.state.navs.map(function (navObj) {
	          return _react2.default.createElement(_nav_item2.default, { key: navObj.id, title: navObj.title, to: navObj.to });
	        })
	      );
	    }
	  }]);
